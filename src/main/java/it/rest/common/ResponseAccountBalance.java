...
/**
 * <p>Classe Java per ResponseAccountBalance complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="status" type="{it:rest:common}Status"/&gt;
 *         &lt;element name="error" type="{it:rest:common}Error"/&gt;
 *         &lt;element name="payload" type="{it:rest:common}AccountBalance" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ResponseAccountBalance", propOrder = {
    "status",
    "error",
    "payload"
})
    ...
    implements Serializable
{
    ...
    @XmlElement(required = true)
    protected List<AccountBalance> payload;
    ...
    public List<AccountBalance> getPayload() {
        if (payload == null) {
            payload = new ArrayList<AccountBalance>();
        }
        return this.payload;
    }
